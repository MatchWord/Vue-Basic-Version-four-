          ...
          <div class="section-content">
            ...
            <div class="ant-form-item">
              ...
              <div class="ant-form-item-control-wrapper">
                ...
                >
                  <div class="choice-item" v-for="element in activeCenterBackData.defaultArr" :key="element.lableV">
                    <i class="el-icon-rank"></i>
                    <el-radio v-model="activeCenterBackData.defaultVal" :label="element.lableV"></el-radio>
                    <el-input size="mini" style="width: 70%;" class="inputM" v-model="element.val"></el-input>
                    <i class="el-icon-delete" @click="deleteLable(element)"></i>
                  </div>
                </draggable>
...
export default {
  ...
  methods: {
    ...
    deleteLable (obj) {
      this.activeCenterBackData.defaultArr = this.activeCenterBackData.defaultArr.filter(el => {
        return el.lableV !== obj.lableV
      })
    },
    num () {
      var mm = Math.random()
    ...
    addItem () {
      this.activeCenterBackData.defaultArr.push({lableV: this.num(), val: '选择'})
    }
  }
};
</script>
