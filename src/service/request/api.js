...
import { API_DEFAULT_CONFIG } from "@/config/BasicConfig";
    ...
    apis.forEach(api => {
      ...
      Object.defineProperty(this.api, apiNamespace, {
        value (outerParams, outerOptions) {
          // 如果没传入参数 则传递默认参数
          const data = Array.isArray(outerParams) ? outerParams : _isEmpty(outerParams) ? params : _assign({}, params, outerParams)
          // 开启debug时打印一些提示信息
